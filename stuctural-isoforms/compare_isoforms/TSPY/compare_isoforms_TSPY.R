...
for (i in 1:307){
  ...
  filename <- paste("C:/Users/gresh/Downloads/temp/TSPY/transcript_", i, 
                    ".TSPY_transcripts.gff.tmap", sep='')
...
alignment <- 
  readAAStringSet("C:/Users/gresh/Downloads/temp/TSPY/TSPY_algn.fa")
...
write.csv(all_isoforms, 
          "C:/Users/gresh/Downloads/temp/TSPY/all_isoforms.csv", 
          row.names = FALSE)
...
plot <-
  ...
  scale_y_discrete(limits=
                   ...
                   position = "right")+
  labs(title = expression(bolditalic("TSPY")),subtitle = "structural isoforms") +
  theme_pubclean()+
...
ggsave("C:/Users/gresh/Downloads/temp/TSPY/plot_structural_isoforms.png", 
       plot, width = 6, height = 25, units = "cm")
...
plot <-
  ...
  scale_y_discrete(limits=
                   ...
                   position = "right")+
  labs(title = expression(bolditalic("TSPY")),subtitle = "sequence isoforms") +
  theme_pubclean()+
  theme(axis.text.x = element_text(angle = -90, hjust = 0, vjust=0.5),
        legend.position = "none",
        axis.title.x = element_blank(),
...
ggsave("C:/Users/gresh/Downloads/temp/TSPY/plot_sequence_isoforms.png", 
       plot, width = 6, height = 65, units = "cm")
...
png("C:/Users/gresh/Downloads/gffcompare/TSPY/plot_seqid.png", width = 800, height = 800, units = "px")
...
write.csv(df_seqid, 
          "C:/Users/gresh/Downloads/gffcompare/TSPY/isoform_seqid.csv", 
          row.names = TRUE)
