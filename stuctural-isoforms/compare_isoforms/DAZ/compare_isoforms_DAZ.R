...
for (i in 1:156){
  ...
  filename <- paste("C:/Users/gresh/Downloads/temp/DAZ/transcript_", i, 
                    ".DAZ_transcripts.gff.tmap", sep='')
...
alignment <- 
  readAAStringSet("C:/Users/gresh/Downloads/temp/DAZ/DAZ_algn.fa")
...
write.csv(all_isoforms, 
          "C:/Users/gresh/Downloads/temp/DAZ/all_isoforms.csv", 
          row.names = FALSE)
...
plot <-
  ...
  scale_y_discrete(limits=
                   ...
                   position = "right")+
  labs(title = expression(bolditalic("DAZ")),subtitle = "structural isoforms") +
  theme_pubclean()+
...
ggsave("C:/Users/gresh/Downloads/temp/DAZ/plot_structural_isoforms.png", 
       plot, width = 6, height = 40, units = "cm")
...
plot <-
  ...
  scale_y_discrete(limits=
                   ...
                   position = "right")+
  labs(title = expression(bolditalic("DAZ")),subtitle = "sequence isoforms") +
  theme_pubclean()+
  theme(axis.text.x = element_text(angle = -90, hjust = 0, vjust=0.5),
        legend.position = "none",
        axis.title.x = element_blank(),
...
ggsave("C:/Users/gresh/Downloads/temp/DAZ/plot_sequence_isoforms.png", 
       plot, width = 6, height = 50, units = "cm")
...
png("C:/Users/gresh/Downloads/gffcompare/DAZ/plot_seqid.png", width = 800, height = 800, units = "px")
...
write.csv(df_seqid, 
          "C:/Users/gresh/Downloads/gffcompare/DAZ/isoform_seqid.csv", 
          row.names = TRUE)
