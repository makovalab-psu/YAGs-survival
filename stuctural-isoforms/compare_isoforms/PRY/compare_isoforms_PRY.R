...
for (i in 1:12){
  ...
  filename <- paste("C:/Users/gresh/Downloads/temp/PRY/transcript_", i, 
                    ".PRY_transcripts.gff.tmap", sep='')
...
alignment <- 
  readAAStringSet("C:/Users/gresh/Downloads/temp/PRY/PRY_algn.fa")
...
write.csv(all_isoforms, 
          "C:/Users/gresh/Downloads/temp/PRY/all_isoforms.csv", 
          row.names = FALSE)
...
plot <-
  ...
  scale_y_discrete(limits=
                   ...
                   position = "right")+
  labs(title = expression(bolditalic("PRY")),subtitle = "structural isoforms") +
  theme_pubclean()+
...
ggsave("C:/Users/gresh/Downloads/temp/PRY/plot_structural_isoforms.png", 
...
plot <-
  ...
  scale_y_discrete(limits=
                   ...
                   position = "right")+
  labs(title = expression(bolditalic("PRY")),subtitle = "sequence isoforms") +
  theme_pubclean()+
  theme(axis.text.x = element_text(angle = -90, hjust = 0, vjust=0.5),
        legend.position = "none",
        axis.title.x = element_blank(),
...
ggsave("C:/Users/gresh/Downloads/temp/PRY/plot_sequence_isoforms.png", 
...
png("C:/Users/gresh/Downloads/gffcompare/PRY/plot_seqid.png", width = 800, height = 800, units = "px")
...
write.csv(df_seqid, 
          "C:/Users/gresh/Downloads/gffcompare/PRY/isoform_seqid.csv", 
          row.names = TRUE)
