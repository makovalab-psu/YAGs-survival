...
for (i in 1:76){
  ...
  filename <- paste("C:/Users/gresh/Downloads/temp/BPY2/transcript_", i, 
                    ".BPY2_transcripts.gff.tmap", sep='')
...
tmap <-
  tmap %>% 
  filter(qry_gene_id %in% tmap$ref_id)
...
alignment <- 
  readAAStringSet("C:/Users/gresh/Downloads/temp/BPY2/BPY2_algn.fa")
...
write.csv(all_isoforms, 
          "C:/Users/gresh/Downloads/temp/BPY2/all_isoforms.csv", 
          row.names = FALSE)
...
plot <-
  ...
  scale_y_discrete(limits=
                   ...
                   position = "right")+
  labs(title = expression(bolditalic("BPY2")),subtitle = "structural isoforms") +
  theme_pubclean()+
...
ggsave("C:/Users/gresh/Downloads/temp/BPY2/plot_structural_isoforms.png", 
...
plot <-
  ...
  scale_y_discrete(limits=
                   ...
                   position = "right")+
  labs(title = expression(bolditalic("BPY2")),subtitle = "sequence isoforms") +
  theme_pubclean()+
  theme(axis.text.x = element_text(angle = -90, hjust = 0, vjust=0.5),
        legend.position = "none",
        axis.title.x = element_blank(),
...
ggsave("C:/Users/gresh/Downloads/temp/BPY2/plot_sequence_isoforms.png", 
       plot, width = 6, height = 10, units = "cm")
...
png("C:/Users/gresh/Downloads/gffcompare/BPY2/plot_seqid.png", width = 800, height = 800, units = "px")
...
write.csv(df_seqid, 
          "C:/Users/gresh/Downloads/gffcompare/BPY2/isoform_seqid.csv", 
          row.names = TRUE)
