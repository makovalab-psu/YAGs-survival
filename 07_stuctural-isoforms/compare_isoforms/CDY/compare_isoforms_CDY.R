...
for (i in 1:57){
  ...
  filename <- paste("C:/Users/gresh/Downloads/temp/CDY/transcript_", i, 
                    ".CDY_transcripts.gff.tmap", sep='')
...
alignment <- 
  readAAStringSet("C:/Users/gresh/Downloads/temp/CDY/CDY_algn.fa")
...
write.csv(all_isoforms, 
          "C:/Users/gresh/Downloads/temp/CDY/all_isoforms.csv", 
          row.names = FALSE)
...
plot <-
  ...
  scale_y_discrete(limits=
                   ...
                   position = "right")+
  labs(title = expression(bolditalic("CDY")),subtitle = "structural isoforms") +
  theme_pubclean()+
...
ggsave("C:/Users/gresh/Downloads/temp/CDY/plot_structural_isoforms.png", 
       plot, width = 6, height = 7, units = "cm")
...
plot <-
  ...
  scale_y_discrete(limits=
                   ...
                   position = "right")+
  labs(title = expression(bolditalic("CDY")),subtitle = "sequence isoforms") +
  theme_pubclean()+
  theme(axis.text.x = element_text(angle = -90, hjust = 0, vjust=0.5),
        legend.position = "none",
        axis.title.x = element_blank(),
...
ggsave("C:/Users/gresh/Downloads/temp/CDY/plot_sequence_isoforms.png", 
