...
for (i in 1:4){
  ...
  filename <- paste("C:/Users/gresh/Downloads/temp/VCY/transcript_", i, 
                    ".VCY_transcripts.gff.tmap", sep='')
...
alignment <- 
  readAAStringSet("C:/Users/gresh/Downloads/temp/VCY/VCY_algn.fa")
...
write.csv(all_isoforms, 
          "C:/Users/gresh/Downloads/temp/VCY/all_isoforms.csv", 
          row.names = FALSE)
...
plot <-
  ...
  scale_y_discrete(limits=
                   ...
                   position = "right")+
  labs(title = expression(bolditalic("VCY")),subtitle = "structural isoforms") +
  theme_pubclean()+
...
ggsave("C:/Users/gresh/Downloads/temp/VCY/plot_structural_isoforms.png", 
...
plot <-
  ...
  scale_y_discrete(limits=
                   ...
                   position = "right")+
  labs(title = expression(bolditalic("VCY")),subtitle = "sequence isoforms") +
  theme_pubclean()+
  theme(axis.text.x = element_text(angle = -90, hjust = 0, vjust=0.5),
        legend.position = "none",
        axis.title.x = element_blank(),
...
ggsave("C:/Users/gresh/Downloads/temp/VCY/plot_sequence_isoforms.png", 
...
png("C:/Users/gresh/Downloads/gffcompare/VCY/plot_seqid.png", width = 800, height = 800, units = "px")
...
write.csv(df_seqid, 
          "C:/Users/gresh/Downloads/gffcompare/VCY/isoform_seqid.csv", 
          row.names = TRUE)
